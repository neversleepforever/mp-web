  ...
  return (
    <>
      <div className=" md:grid md:grid-cols-2 dark:text-white bg-[#454545] ">
        ...
        <div className="scrollbar-hide bg-black bg-[url('/images/scantexture-dark.jpg')] bg-cover bg-center md:col-start-2 pt-12 pb-16 px-6 md:pt-16 h-[100dvh] overflow-y-scroll xl:px-26 ">
