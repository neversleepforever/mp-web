...
// Variable: videoQuery
// Query: *[_type == "video" && slug.current == $slug][0]{  _id,  title,  subtitle,  photographer,  date,  "slug": slug.current,  description,  videoUrl,  muxVideo {    asset->{      playbackId,      assetId,      status    }  }}
