...
// Variable: folioQuery
// Query: *[_type == "gallery" && slug.current == $slug][0]{    _id,    title,    subtitle,    displayTitle,    photographer,    date,    description,    "slug": slug.current,    images[]{      alt,      credit,      asset->{        _id,        metadata {          lqip,          dimensions {            width,            height          }        }      }    }  }
...
// Query: *[_type == "services"][0]{    content[]{      ...,      _type == "image" => {        ...,        "asset": asset->{          _id,          metadata {            lqip,            dimensions { width, height }          }        }      },      _type == "servicesSection" => {        ...,        body[]{          ...,          _type == "image" => {            ...,            "asset": asset->{              _id,              metadata {                lqip,                dimensions { width, height }              }            }          }        }      },      _type == "ratesSection" => {        ...,        rates[]{          ...,          _type == "image" => {            ...,            "asset": asset->{              _id,              metadata {                lqip,                dimensions { width, height }              }            }          }        }      },      _type == "outcallSection" => {        ...,        body[]{          ...,          _type == "image" => {            ...,            "asset": asset->{              _id,              metadata {                lqip,                dimensions { width, height }              }            }          }        }      },      _type == "virtualSection" => {        ...,        body[]{          ...,          _type == "image" => {            ...,            "asset": asset->{              _id,              metadata {                lqip,                dimensions { width, height }              }            }          }        }      }    }  }
export type ServicesQueryResult = null
// Variable: aboutQuery
// Query: *[_type == "about"][0]{    _id,    content[]{      ...,      _type == "image" => {        alt,        asset->{          _id,          url,          metadata {            lqip,            dimensions { width, height }          }        }      }    }  }
