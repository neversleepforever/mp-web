...
// Query: *[_type == "gallery" && defined(slug.current)] | order(date desc, _updatedAt desc) {    _id,    title,    subtitle,    displayTitle,    photographer,    date,    "slug": slug.current,    images[]{      asset->{        url      },      credit    }  }
